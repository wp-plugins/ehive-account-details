		...
		<div class="ehive-item-metadata-wrap">
			...
			<div class="ehive-field ehive-identifier-contact-details">
				...
				<?php if ($account->postalAddress) { ?>
					<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/postal.png" width="21" height="15" alt="Postal address" title="Postal address"/>
				...
				<?php if ($account->phoneNumber) { ?>
					<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/telephone.png" width="21" height="15" alt="Telephone number" title="Telephone number"/>
		        ...
		        <?php if ($account->facsimile) {?>
		        	<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/fax.png" width="21" height="15" alt="Fax number" title="Fax number"/>
		        ...
		        <?php if ($account->website) {?>
		        	<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/website.png" width="21" height="16" alt="Web address" title="Web address"/>
		        ...
		        <?php if ($account->emailAddress) {?>
		        	<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/email.png" width="21" height="15" alt="eMail address" title="eMail address"/>
			...
			<div class="ehive-field ehive-identifier-visitor-information">
				...
				<?php if ($account->physicalAddress) { ?>
					<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/physical.png" width="21" height="15" alt="Physical address" title="Physical address"/>
				...
				<?php if ($account->hoursOfOperation) { ?>
					<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/hours.png" width="21" height="15" alt="Hours of operation" title="Hours of operation"/>
				...
				<?php if ($account->admissionCharges) { ?>
					<li>
						<img src="/wp-content/plugins/eHiveAccountDetails/images/charges.png" width="21" height="15" alt="Admission charges" title="Admission charges"/>
			...
			<div class="ehive-field ehive-identifier-facilities">
				...
				<ul>
				<?php
				if ($account->wheelChairAccessFacility) echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/wheelchairaccess.png" alt="Wheelchair Access" title="Wheelchair Access"/></li>';
				if ($account->cafeFacility)             echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/cafe.png" alt="Cafe" title="Cafe"/></li>';
				if ($account->referenceLibraryFacility) echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/referencelibrary.png" alt="Reference Library" title="Reference Library"/></li>';
				if ($account->parkingFacility)          echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/parking.png" alt="Parking" title="Parking"/></li>';
				if ($account->shopFacility)             echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/shop.png" alt="Shop" title="Shop"/></li>';
				if ($account->functionSpaceFacility)    echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/functionspaces.png" alt="Function Space" title="Function Space"/></li>';
				if ($account->guidedTourFacility)       echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/guidedtour.png" alt="Guided Tours" title="Guided Tours"/></li>';
				if ($account->publicProgrammesFacility) echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/publicprogrammes.png" alt="Public Programmes" title="Public Programmes"/></li>';
				if ($account->membershipClubFacility)   echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/membershipclub.png" alt="Membership Club" title="Membership Club"/></li>';
				if ($account->toiletFacility)           echo '<li><img src="/wp-content/plugins/eHiveAccountDetails/images/toilets.png" alt="Toilets" title="Toilets"/></li>';	
